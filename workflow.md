...
```bash
./.venv/bin/python scripts/build_ns3_gt_distance_reports.py \
  --excel-file /path/to/HCV_BlastHits_2026_04_29.xlsx \
  --sheet NS3_May11 \
...
```bash
./.venv/bin/python scripts/build_ns3_gt_resistance_profile_summary.py \
...
```bash
./.venv/bin/python scripts/build_ns5a_gt_resistance_profile_summary.py \
...
```bash
./.venv/bin/python scripts/build_ns5b_gt_resistance_profile_summary.py \
...
- `scripts/build_ns3_gt_distance_reports.py`
...
- `scripts/build_ns3_subtype_distance_report.py`
...
2. `build_ns3_gt_distance_reports.py` assigns `NS3` genotype to each accession.
3. `build_ns3_subtype_distance_report.py` assigns `NS3` subtype to each accession using genotype-matched subtype references.

## New NS5A Workflow

I added `NS5A` counterparts to the existing `NS3` scripts:

1. `scripts/build_ns5a_gt_distance_reports.py`
...
2. `scripts/build_ns5a_subtype_distance_report.py`
...
1. `scripts/build_ns5b_gt_distance_reports.py`
...
2. `scripts/build_ns5b_subtype_distance_report.py`
