...
2. `scripts/build_ns3_gt_allstudies.py`
3. `scripts/build_ns3_sourcefeatures_csv.py` if GenBank source files are available
4. `scripts/build_ns3_sourcefeatures_grouped_csv.py` if source features were extracted
5. `scripts/build_ns3_subtype_allstudies_wseqs.py`
6. `scripts/build_ns3_subtype_with_gt_aa.py`
7. `scripts/build_ns3_completeprofiles_tabspergt.py`
8. `scripts/build_ns3_gt_ras_profiles.py`
9. `scripts/build_ns3_subtype_ras_profiles.py`
